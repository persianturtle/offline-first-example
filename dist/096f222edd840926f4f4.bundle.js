...
/******/ 	__webpack_require__.p = "/offline-first-example/dist/";
  ...
  options || (options = {});
    ...
    if (hasSW()) {
      var registration = navigator.serviceWorker
        .register(
          "/offline-first-example/dist/sw.js"
    ...
    if (window.applicationCache) {
      var directory = "/offline-first-example/dist/appcache/";
      var name = "manifest";
...
var _idbKeyval = __webpack_require__(115);

var _idbKeyval2 = _interopRequireDefault(_idbKeyval);

var _runtime = __webpack_require__(116);
...
fetch('/offline-first-example/dist/video/video.mp4').then(function (response) {
  return response.arrayBuffer();
}).then(function (buffer) {
  _idbKeyval2.default.set('video', buffer).then(setVideoSourceFromBuffer(video, buffer));
}).catch(function (error) {
  _idbKeyval2.default.get('video').then(function (buffer) {
    return setVideoSourceFromBuffer(video, buffer);
  });
